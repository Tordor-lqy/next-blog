...
import { IconLogoGnome } from "@/components/icons/logos/ icon-logo-gnome";
import { IconSkillFastAPI } from "@/components/icons/skills/icon-skill-fastapi";
import { IconSkillSQLAlchemy } from "@/components/icons/skills/icon-skill-sqlalchemy";
import { IconLogoAnt } from "@/components/icons/logos/icon-logo-ant";
import { IconSkillDaisyUI } from "@/components/icons/skills/icon-skill-daisyui";
import { IconSkillShadcnUI } from "@/components/icons/skills/icon-skill-shadcnui";
    ...
    <div className="flex w-full flex-col justify-center px-6 pb-24 pt-8">
      <section className="w-screen-wrapper prose prose-neutral mx-auto max-w-screen-wrapper dark:prose-invert">
        ...
        >
          ...
          <p>
            Hi~ 我是{NICKNAME}
            ，一名河南农业大学计算机专业的学生， 热爱编程，喜欢折腾， 目标成为优秀的全栈开发工程师。
          </p>
        </div>
        ...
        >
          ...
          <ul>
            ...
            <li>
              ...
              Next.js +
                <IconLogoAnt className="mx-1 translate-y-0.5" />
              Ant Design
              + <IconSkillDaisyUI className="mx-1 translate-y-0.5" />
              daisy ui
              + <IconSkillShadcnUI className="mx-1 translate-y-0.5" />
              shadcn ui
              <>
        ...
        >
          ...
          <ul>
            ...
            <li>
              <IconSkillFastAPI className="mx-1 translate-y-0.5" />
              FastAPI + 
              <IconSkillSQLAlchemy className="mx-1 translate-y-0.5" />
              sqlalchemy
              <>
                <IconSkillMysqlDark className="mx-1 translate-y-0.5 dark:hidden" />
                <IconSkillMysqlLight className="mx-1 hidden translate-y-0.5 dark:inline-block" />
        ...
        >
          ...
          <ul>
            ...
            <li>
              用过 <IconLogoUbuntu className="mx-1 translate-y-0.5" />
              Ubuntu 操作系统 + <IconLogoGnome className="mx-1 translate-y-0.5" />
              gnome 桌面环境
              {/* <>
            ...
            <li>
              <IconLogo1panel className="mx-1 translate-y-0.5 text-blue-600" />
              1panel 运维面板
            </li>
            <li>
